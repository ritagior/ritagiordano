...
knitr::include_graphics("img/tool.png")
```

## Freelance audience.

Another question was `As a freelancer, who do you make data visualizations for? Select all that apply.` The majority of the freelancer identify as designer and their audience can be from general public to analyst, from scientist to researcher. Designers are the biggest proportion of freelancers and they also reach almost all the audience indicate in the survey.
...
```
<!-- ![Data Visualization Society Survey](img/survey.png) -->
