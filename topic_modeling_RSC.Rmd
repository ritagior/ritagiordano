...
preview: img/chord_diagram_topic_final.png
---
...
I prepared these visualisations for the editorial article of the journal "Environmental Science: Process and Impact" (2020) March Issue of the Royal Society of Chemistry. The idea behind this project was to find which was the topic for the article submitted in that issue. I thus performed a topic analysis using the title and abstract of the submitters' papers. To represent the topic of each article I used a chord diagram, which I realised with the R package `circlize`.
