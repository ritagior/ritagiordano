...
Here I was to have look at the fertility in the 2010s compared with the 1960s. The bar chart shows a decreasing for each level of income of fertility rates in the 2010s. 
High income countries present a lower fertility rate than low income countries. 
It seems that were women have access to hight education let decrease the fertility rate.
...
With Flourish I realised an interactive visualisation that show the world fertility rate by income. Changing the filter is possible to see the differences between the countries for 2019. 
